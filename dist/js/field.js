        ...
        [
          _c(
            "div",
            {
              ...
              class: {
                "remove-bottom-border": _vm.field.countryCode.value == ""
              }
            },
            [
              _c(
                "div",
                {
                  ...
                  class: {
                    "pb-0": _vm.field.countryCode.value == "",
                    "pb-4": _vm.field.countryCode.value != ""
                  }
                },
                [
                  _c(
                    "form-label",
                    { attrs: { "label-for": _vm.field.countryCode.attribute } },
                    [
                      _vm._v(
                        "\n                        " +
                          _vm._s(_vm.field.countryCode.name) +
                          "\n                    "
                      )
                    ]
                  )
                ...
                [
                  _c(
                    "select-control",
                    {
                      ...
                      attrs: {
                        id: _vm.field.countryCode.attribute,
                        dusk: _vm.field.countryCode.attribute,
                        options: _vm.field.countryCode.options
                      },
                      model: {
                        value: _vm.field.countryCode.value,
                        callback: function($$v) {
                          _vm.$set(_vm.field.countryCode, "value", $$v)
                        },
                        expression: "field.countryCode.value"
                      }
                    },
                    [
          ...
          _vm._v(" "),
          _vm._l(_vm.field.fields, function(subfield, index) {
            return _vm.field.countryCode.value != ""
              ? _c(
                  "div",
                  {
                    staticClass: "flex border-b border-40",
                    class: {
                      "remove-bottom-border":
                        index == _vm.field.fields.length - 1
                    }
                  },
                  [
                    _c(
                      "div",
                      {
                        staticClass: "w-1/5 py-4 pr-8",
                        class: { "pb-0": index == _vm.field.fields.length - 1 }
                      },
                      [
                        _c(
                          "form-label",
                          { attrs: { "label-for": subfield.attribute } },
                          [
                            _vm._v(
                              "\n                        " +
                                _vm._s(subfield.name) +
                                "\n                    "
                            )
                          ]
                        )
                    ...
                    _c(
                      ...
                      [
                        _c("input", {
                          ...
                          domProps: { value: subfield.value },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
                              }
                              _vm.$set(subfield, "value", $event.target.value)
                            }
                          }
                        })
                      ]
