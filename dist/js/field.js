                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                if (country_code) {
                                    Nova.request().get('/nova-vendor/address-field/formats/' + country_code).then(function (response) {
                                        _this.field.format = response.data;
                                    });
                                } else {
              ...
              [
                _c(
                  "form-label",
                  {
                    ...
                    attrs: {
                      "label-for": _vm.field.attribute + "_country_code"
                    }
                  },
                  [
                    _vm._v(
              ...
              [
                _c(
                  "select-control",
                  {
                    ...
                    model: {
                      value: _vm.field.value.country_code,
                      callback: function($$v) {
                        _vm.$set(_vm.field.value, "country_code", $$v)
                      },
                      expression: "field.value.country_code"
                    }
                  },
                  [
                  ...
                  "div",
                  {
                    ...
                    class: {
                      "remove-bottom-border":
                        index == _vm.field.format.fields.length - 1
                    }
                  },
                  [
                    _c(
                      "div",
                      {
                        ...
                        class: {
                          "pb-0": index == _vm.field.format.fields.length - 1
                        }
                      },
                      [
